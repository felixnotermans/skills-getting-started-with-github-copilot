...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training sessions and inter-school soccer matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Practice": {
        "description": "Skills training, drills, and friendly basketball games",
    ...
    "Debate Team": {
        "description": "Practice argumentation, public speaking, and formal debates",
